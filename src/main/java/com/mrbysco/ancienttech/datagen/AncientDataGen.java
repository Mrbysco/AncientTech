...
public class AncientDataGen {
	...
	public static void gatherData(GatherDataEvent.Client event) {
		...
		generator.addProvider(true, new AncientGameEventTagProvider(packOutput, lookupProvider));

		generator.addProvider(true, new AncientLanguageProvider(packOutput));
		generator.addProvider(true, new AncientBlockStateProvider(packOutput));
